...
public class Goibibo {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector(".iLlmqX.sticky")));
		Thread.sleep(3000);
		builder.sendKeys(Keys.END).build().perform();
		Thread.sleep(2000);
		builder.sendKeys(Keys.HOME).build().perform();
		Thread.sleep(2000);
		List<WebElement> findElements = driver.findElements(By.cssSelector(".zAKuQ"));
